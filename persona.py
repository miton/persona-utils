...
personas = [
Persona(149, 'Yaksini',50,'Empress','slash',[])
...
Persona(162, 'Mara',77,'Tower','pierce',[], special=True)
Persona(111, 'Chi You',86,'Tower','pierce',[], restrict='max')
Persona(163, 'Kartikeya',70,'Star','pierce',[], restrict='item')
Persona(1, 'Orpheus',1,'Fool','fire',[], special=True)
Persona(5, 'Nekomata',5,'Magician','fire',[])
Persona(6, 'Pyro Jack',14,'Magician','fire',[])
Persona(147, 'Hua Po',20,'Magician','fire',[], restrict='item')
Persona(18, 'Sati',28,'Magician','fire',[])
Persona(9, 'Rangda',40,'Magician','fire',[])
Persona(48, 'Surt',52,'Magician','fire',[], restrict='max')
...
Persona(158, 'Hell Biker',60,'Hanged Man','fire',[], restrict='item')
...
Persona(139, 'Asura',85,'Sun','fire',[], special=True, restrict='max')
...
Persona(155, 'Empusa',23,'Fortune','wind',[], restrict='item')
...
Persona(69, 'Norn',62,'Fortune','wind',[], special=True, restrict='max')
...
Persona(36, 'Daisoujou',53,'Hierophant','light',[], special=True)
...
Persona(118, 'Sandalphon',74,'Moon','light',[], special=True, restrict='max')
Persona(135, 'Horus',63,'Sun','light',[])
Persona(47, 'Uriel',63,'Aeon','light',[])
Persona(168, 'Atavaka',80,'Aeon','light',[])
Persona(140, 'Metatron',87,'Aeon','light',[], special=True, restrict='max')
...
Persona(97, 'Pale Rider',24,'Death','dark',[], restrict='item')
Persona(96, 'Loa',31,'Death','dark',[])
Persona(94, 'Samael',37,'Death','dark',[])
Persona(93, 'Mot',45,'Death','dark',[])
Persona(91, 'Alice',56,'Death','dark',[], special=True)
Persona(90, 'Thanatos',64,'Death','dark',[], special=True, restrict='max')
Persona(124, 'Chernobog',58,'Moon','dark',[])
Persona(164, 'Baal Zebul',71,'Moon','dark',[])
Persona(166, 'Lucifer',89,'Judgment','dark',[], special=True)
...
Persona(138, 'Messiah',90,'Judgment','l&d',[], special=True, restrict='max')
...
Persona(62, 'Alilat',84,'Empress','recovery',[], restrict='max')
Persona(31, 'Kingu',46,'Emperor','recovery',[])
Persona(34, 'Kohryu',66,'Hierophant','recovery',[], special=True, restrict='max')
...
Persona(21, 'Cybele',68,'Lovers','recovery',[], restrict='max')
Persona(84, 'Attis',67,'Hanged Man','recovery',[], special=True, restrict='max')
...
Persona(64, 'Nebiros',50,'Hermit','status',[], restrict='item')
Persona(63, 'Arahabaki',60,'Hermit','status',[], special=True, restrict='max')
...
Persona(107, 'Lilith',61,'Devil','status',[], special=True, restrict='item')
Persona(106, 'Abaddon',68,'Devil','status',[])
Persona(104, 'Beelzebub',81,'Devil','status',[], special=True, restrict='max')
Persona(121, 'Kaiwan',49,'Star','status',[])
Persona(146, 'Slime',12,'Fool','all',[])
Persona(129, 'Legion',22,'Fool','all',[])
Persona(119, 'Black Frost',34,'Fool','all',[], special=True)
Persona(12, 'Ose',44,'Fool','all',[])
Persona(65, 'Decarabia',50,'Fool','all',[])
Persona(4, 'Loki',58,'Fool','all',[])
Persona(2, 'Susano-o',76,'Fool','all',[], special=True, restrict='max')
Persona(169, 'Orpheus Telos',90,'Fool','all',[], special=True)
]
